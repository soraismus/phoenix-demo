defmodule Assessment.AccountsTest do
  ...
  describe "credentials" do
    alias Assessment.Accounts.Credential

    @valid_attrs %{password_digest: "some password_digest"}
    @update_attrs %{password_digest: "some updated password_digest"}
    @invalid_attrs %{password_digest: nil}
    ...
    test "create_credential/1 with valid data creates a credential" do
      ...
      assert credential.password_digest == "some password_digest"
    end
    ...
    test "update_credential/2 with valid data updates the credential" do
      ...
      assert credential.password_digest == "some updated password_digest"
    end
